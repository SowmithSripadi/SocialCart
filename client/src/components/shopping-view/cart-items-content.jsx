...
import { deleteCartItems as deleteCartItem, updateCartItems as updateCartQuantity } from "@/store/shop/cart-slice";
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <div className="flex flex-col items-end">
        <p className="font-semibold">${(((cartItem?.salePrice > 0 ? cartItem?.salePrice : cartItem?.price) || 0) * cartItem?.quantity).toFixed(2)}</p>
